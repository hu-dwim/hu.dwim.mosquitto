(defpackage :hu.dwim.mosquitto
  ...
  (:export
   ;; NOTE: stay away here from re-exporting stuff from hu.dwim.mosquitto.ffi, because that'll change the behavior of cl:shadow
...
(progn
  ...
  (import-all-owned-symbols :hu.dwim.mosquitto.ffi :hu.dwim.mosquitto)
  #+nil
  (shadowing-import '(hu.dwim.mosquitto.ffi:close
                      hu.dwim.mosquitto.ffi:socket)
                    :hu.dwim.mosquitto))
